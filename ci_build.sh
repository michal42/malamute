...
#    git clone --quiet --depth 1 https://github.com/jedisct1/libzmq libsodium
    git clone --quiet --depth 1 -b 1.0.5-FTY-master https://github.com/42ity/libsodium libsodium
    cd libsodium
